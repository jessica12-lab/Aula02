...
public class DesvioEncadeado {
	...
	public static void main(String[] args) {
		...
		/*if (idade <16) {
			System.out.println("Essa pessoa não podevotar e embarcar");			
		}else {
			if(idade < 18) {
				System.out.println("Tanto a votação quanto o embarque são opcionais para essa pessoa");
			}else {System.out.prrintln("Essa pessoa é obrigada a votar")}
		}*/
		if (idade <16) {
			System.out.println("Essa pessoa não podevotar e embarcar");} else if (idade <18) {
				System.out.println("Tanto a votação quanto o embarque são opcionais para essa pessoa");
				}else {
